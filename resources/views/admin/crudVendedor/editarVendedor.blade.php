...
<head>
    ...
    <title>Editar Vendedor - Marketplace</title>
...
<main class="min-h-screen flex items-center justify-center py-8">
    ...
    <div class="bg-gray-800 p-8 rounded-lg shadow-md w-full max-w-4xl">
        <div class="text-center mb-8">
            <h1 class="text-2xl font-bold text-white">Editar Vendedor</h1>
            <p class="text-gray-400">Modifique la información del vendedor</p>
        </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" id="name" name="name" value="{{-- $vendedor->name --}}"
                    ...
                    <div class="mb-4">
                        ...
                        <input type="email" id="email" name="email" value="{{-- $vendedor->email --}}"
                               class="w-full px-3 py-2 bg-gray-700 border border-gray-600 rounded-md text-white focus:outline-none focus:ring-2 focus:ring-blue-500"
                               required>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="tel" id="phone" name="phone" value="{{-- $vendedor->phone --}}"
                               class="w-full px-3 py-2 bg-gray-700 border border-gray-600 rounded-md text-white focus:outline-none focus:ring-2 focus:ring-blue-500"
                               required>
                    </div>

                    <div class="mb-4">
                        <label for="password" class="block text-gray-300 text-sm font-bold mb-2">Nueva Contraseña</label>
                        <input type="password" id="password" name="password"
                               class="w-full px-3 py-2 bg-gray-700 border border-gray-600 rounded-md text-white focus:outline-none focus:ring-2 focus:ring-blue-500">
                        <p class="text-xs text-gray-400 mt-1">Dejar en blanco si no desea cambiar la contraseña</p>
                    </div>

                    <div class="mb-4">
                        <label for="password_confirmation" class="block text-gray-300 text-sm font-bold mb-2">Confirmar Nueva Contraseña</label>
                ...
                <div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" id="business_name" name="business_name" value="{{-- $vendedor->business_name --}}"
                               class="w-full px-3 py-2 bg-gray-700 border border-gray-600 rounded-md text-white focus:outline-none focus:ring-2 focus:ring-blue-500"
                               required>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="tel" id="business_phone" name="business_phone" value="{{-- $vendedor->business_phone --}}"
                               class="w-full px-3 py-2 bg-gray-700 border border-gray-600 rounded-md text-white focus:outline-none focus:ring-2 focus:ring-blue-500"
                               required>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <textarea id="business_address" name="business_address" rows="2"
                                  class="w-full px-3 py-2 bg-gray-700 border border-gray-600 rounded-md text-white focus:outline-none focus:ring-2 focus:ring-blue-500"
                                  required>{{-- $vendedor->business_address --}}</textarea>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <textarea id="business_description" name="business_description" rows="3"
                                  class="w-full px-3 py-2 bg-gray-700 border border-gray-600 rounded-md text-white focus:outline-none focus:ring-2 focus:ring-blue-500">{{-- $vendedor->business_description --}}</textarea>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <select id="estado" name="estado"
                            ...
                            <option value="pendiente" {{-- $vendedor->estado == 'pendiente' ? 'selected' : '' --}}>Pendiente</option>
