...
<head>
    ...
    <title>Crear Administrador - Marketplace</title>
...
<main class="min-h-screen flex items-center justify-center py-8">
    ...
    <div class="bg-gray-800 p-8 rounded-lg shadow-md w-full max-w-2xl">
        <div class="text-center mb-8">
            <h1 class="text-2xl font-bold text-white">Crear Nuevo Administrador</h1>
            <p class="text-gray-400">Complete la información del nuevo administrador</p>
        </div>
        ...
        <form method="POST" action="{{route('crear.admin')}}">
            @csrf
            ...
            <div class="mb-4">
                ...
                <p class="text-gray-400 text-xs mt-1">Mantén presionada la tecla Ctrl para seleccionar múltiples
                    opciones.</p>
            </div>
